...
//        Teacher jerry = new Teacher("Jerry", 21, klass);
...
//        Student tom = new Student("Jerry", 21, klass);
...
//        Teacher tom = new Teacher( "Tom", 21, klass);
//        Student jerry = new Student("Jerry", 23, klass);
...
//        Teacher tom = new Teacher( "Tom", 21, klass);
//        Student jerry = new Student("Jerry", 23, new Klass(3));
